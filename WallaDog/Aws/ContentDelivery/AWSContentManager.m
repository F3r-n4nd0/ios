...
+ (instancetype)sharedManager {
    ...
    dispatch_once(&onceToken, ^{
        _sharedManager = [[AWSContentManager alloc] initWithType:AWSContentManagerTypeCloudFront
                                                          bucket:AWS_CONTENT_MANAGER_CLOUD_FRONT_ORIGIN_S3
                                                          domain:AWS_CONTENT_MANAGER_CLOUD_FRONT_DOMAIN
                                                      identifier:AWS_CONTENT_MANAGER_CLOUD_FRONT_ORIGIN_S3];
    });
